...
import 'package:forms_app/infractructure/inputs/inputs.dart';
import 'package:formz/formz.dart';

part 'register_state.dart';

class RegisterCubit extends Cubit<RegisterFromState> {
  RegisterCubit() : super(const RegisterFromState());
